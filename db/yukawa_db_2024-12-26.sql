...
CREATE TABLE `pinboard_item` (
  ...
  PRIMARY KEY (`uuid`),
  CONSTRAINT `created_by` FOREIGN KEY (`uuid`) REFERENCES `users` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pinboard_item_attatchments` (
  ...
  PRIMARY KEY (`uuid`),
  KEY `FK107qwf37bigssndlygjcloind` (`pinboard_item_uuid`),
  CONSTRAINT `FK107qwf37bigssndlygjcloind` FOREIGN KEY (`pinboard_item_uuid`) REFERENCES `pinboard_item` (`uuid`),
  CONSTRAINT `pinboard_item_uuid` FOREIGN KEY (`uuid`) REFERENCES `pinboard_item` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES ('05cf3b86-b2b0-4405-80d9-70e59114a3f5',2,'Test','User',NULL,'testuser@example.com','password123',NULL);
...
-- Dump completed on 2024-12-26 23:11:30
